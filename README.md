...
<a href="https://towerdefense.chanmeng.org/">
  <img src="docs/showcase/hero.webp" alt="Te Pā Tiaki game menu — vibrant teal starburst background, bold yellow 'TE PĀ TIAKI' headline, map and difficulty selectors, START GAME button" width="100%">
</a>

![Demo: opening the map picker (Te Awa / Te Maunga / Te Moana), switching difficulty, and exploring the MORE menu (Leaderboard, Daily Challenge, Achievements)](docs/showcase/demo.gif)

<details>
<summary>🗺️ Map selection and MORE menu</summary>

<img src="docs/showcase/map-select.webp" width="100%" alt="Map picker open — three Māori-named maps: Te Awa (The River), Te Maunga (The Mountain), Te Moana (The Ocean)">

<img src="docs/showcase/more-panel.webp" width="100%" alt="MORE menu expanded — Leaderboard, Daily Challenge, Achievements, Settings options over the teal starburst background">
...
<img src="docs/showcase/mobile-hero.webp" width="390" alt="Te Pā Tiaki on mobile — stacked map/difficulty controls and START GAME button on the teal halftone background">
